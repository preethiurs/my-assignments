    ...
    loadArtcile(articleId)
    {
        ...
        var obj=state.map((articles) =>{
            if(articles.articleId==articleId)
            {
                ...
                this.setState({ articleid : articles.articleId ,articleTitle : articles.articleTitle, articleBody : articles.articleBody , editbtn : true });
                return articles;
            }
        })
    ...
    render() {
        ...
        if(this.state.editarea)
        {
            ...
            editarea=<div>
                ...
                <input type="text" value={this.state.articleTitle} id="articletitle" onChange={this.onChangeInput.bind(this)} /><br/>
                <textarea rows="4" cols="100" value={this.state.articleBody} onChange={this.onChangeTextArea.bind(this)} id="articlebody"></textarea><br/><br/>
